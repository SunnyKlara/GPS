...
//                                 UART配置                                        //
//*********************************************************************************//
#define TCFG_UART0_ENABLE					ENABLE_THIS_MOUDLE                     //串口打印模块使能(SDK内部依赖)
#define TCFG_UART0_RX_PORT					NO_CONFIG_PORT                         //串口接收脚配置（用于打印可以选择NO_CONFIG_PORT）
#define TCFG_UART0_TX_PORT  				NO_CONFIG_PORT                         //串口发送脚禁用(PA0给TM1638,PA5给GPS)
...
#define KEY_NUM                            	8   //8个按键全部启用(实测ADC值已标定)
...
//                                 adkey 配置                                      //
//*********************************************************************************//
#define TCFG_ADKEY_ENABLE                   ENABLE_THIS_MOUDLE  //AD按键启用(已标定)
#define TCFG_ADKEY_PORT                     IO_PORTA_08         //AD按键端口(PA8: 8个按键ADC分压)
#define TCFG_ADKEY_AD_CHANNEL               AD_CH_PA8           //AD通道对应PA8
 ...
 * POWER     840     7
 */
#define TCFG_ADKEY_AD0      (0)         //NEXT:   0
#define TCFG_ADKEY_AD1      (137)       //PREV:   137
#define TCFG_ADKEY_AD2      (225)       //MODE:   225
#define TCFG_ADKEY_AD3      (301)       //电话:   301
#define TCFG_ADKEY_AD4      (419)       //VOL+:   419
#define TCFG_ADKEY_AD5      (536)       //VOL-:   536
#define TCFG_ADKEY_AD6      (720)       //PLAY:   720
#define TCFG_ADKEY_AD7      (840)       //POWER:  840
#define TCFG_ADKEY_AD8      (0x3ffL)    //未使用
#define TCFG_ADKEY_AD9      (0x3ffL)    //未使用
...
#define TCFG_ADKEY_VOLTAGE7 ((TCFG_ADKEY_AD7 + TCFG_ADKEY_VDDIO) / 2)
#define TCFG_ADKEY_VOLTAGE8 (0x3ffL)
#define TCFG_ADKEY_VOLTAGE9 (0x3ffL)
